...
TRANSFORM_ENVIRONMENT = "transform"
TAXI_TRANSFORM_ENVIRONMENT = "taxi_transform"
DELETING_PROBABILITIES_ENV = "deleting_probabilities"
# ====================== params ===================== #
GAMMA = 0.9  # ............. -d : discount factor, default=0.9
LIVING_REWARD = -1  # ...... -r : Reward for living for a time step, default=0.0
NOISE = 0.2  # ............. -n : How often action results in unintended direction, default=0.2
