...
class Taxi_Processor:
    ...
    def taxi_expert_to_model(self, state):
        ...
        processed = [0 for _ in range(2 + 2 * len(
            self.locs) + 1)]  # (2 for taxi row and col, 2 * num locations for one-hot encodings of taxi and passenger locations, one more for if the passenger is in the taxi)
