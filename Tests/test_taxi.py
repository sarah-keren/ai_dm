...
def main_taxi():
    ...
    # perform BFS
    [best_value, best_node, best_plan, explored_count, ex_terminated, results_log] = best_first_search(problem=taxi_p, frontier=utils.FIFOQueue(), closed_list=utils.ClosedListOfSequences(), termination_criteria=utils.TerminationCriteriaGoalStateReached(), evaluation_criteria=utils.EvaluationCriteriaGoalCondition(), prune_func=None, log=True,
